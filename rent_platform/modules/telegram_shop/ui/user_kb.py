...
BTN_ADMIN = "🛠 Адмінка"
BTN_ADMIN_ORDERS = "🧾 Замовлення"  # залишаємо як константу (може знадобитись в інших місцях)
BTN_ADMIN_INTEGRATIONS = "🔑 ІP ключі"  # renamed
...
def _admin_rows() -> list[list[str]]:
    """
    Внизу (reply keyboard) показуємо тільки "Адмінка".
    "Замовлення" та "ІP ключі" тримаємо всередині адмін-меню (inline),
    щоб не захаращувати нижню панель.
    """
    return [
        [BTN_ADMIN],
    ]
